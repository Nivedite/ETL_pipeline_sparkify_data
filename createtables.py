...
def create_database():
    ...
    conn = psycopg2.connect("host=127.0.0.1 dbname=studentdb user=postgres password=Nive@1999")
    ...
    conn = psycopg2.connect("host=127.0.0.1 dbname=sparkifydb user=postgres password=Nive@1999")
    cur = conn.cursor()
